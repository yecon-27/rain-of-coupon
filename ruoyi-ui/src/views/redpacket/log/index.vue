<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['redpacket:log:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['redpacket:log:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="logList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="抽奖时间" align="center" prop="createdAt" width="180">
...
<script>
import { listLog, getLog, delLog, addLog, updateLog } from "@/api/redpacket/log"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除用户抽奖记录编号为"' + ids + '"的数据项？').then(function() {
        return delLog(ids)
      }).then(() => {
        this.getList()
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('redpacket/log/export', {
        ...this.queryParams
