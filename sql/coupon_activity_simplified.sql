...
('背景图', 'home_bg', 'home.png', '/image/coupon/home.png', '主页', '主页背景图'),
('立即挑战按钮', 'challenge_btn', 'button.png', '/image/coupon/button.png', '主页', '立即挑战按钮'),
('规则按钮', 'rule_btn', 'gz.png', '/image/coupon/gz.png', '主页面', '规则按钮'),
('通用规则按钮', 'common_rule_btn', 'hdgz.png', '/image/coupon/hdgz.png', '通用', '通用规则按钮'),
('券包按钮', 'coupon_btn', 'qb.png', '/image/coupon/qb.png', '通用', '券包按钮'),
('红包雨来袭', 'redpacket_rain', 'zbh.png', '/image/coupon/zbh.png', '红包雨组件', '一大波红包雨即将来袭'),
('红包图片', 'red_packet_bag', 'luckyBag.png', '/image/coupon/luckyBag.png', '红包雨组件', '红包雨中的红包图片'),
('一秒特效', 'countdown_1', '1.png', '/image/coupon/1.png', '倒计时组件', '一秒特效'),
('二秒特效', 'countdown_2', '2.png', '/image/coupon/2.png', '倒计时组件', '二秒特效'),
('三秒特效', 'countdown_3', '3.png', '/image/coupon/3.png', '倒计时组件', '三秒特效'),
('计时按钮', 'timer_btn', 'ds.png', '/image/coupon/ds.png', '红包雨组件', '计时按钮'),
('红包个数', 'packet_count', 'sl.png', '/image/coupon/sl.png', '红包雨组件', '红包个数显示'),
('福气+1按钮', 'luck_plus_btn', '福气+1.png', '/image/coupon/福气+1.png', '鼓励提示组件', '福气+1按钮'),
('活动拥挤', 'crowding_tip', '活动拥挤.png', '/image/coupon/活动拥挤.png', '拥挤提示组件', '活动拥挤提示图'),
('加载动画', 'loading_gif', '加载.gif', '/image/coupon/加载.gif', '加载页面', '加载动画'),
('188元中奖图', 'prize_188', '188.png', '/image/coupon/188.png', '中奖弹窗', '188元中奖图'),
('588元中奖图', 'prize_588', '588.png', '/image/coupon/588.png', '中奖弹窗', '588元中奖图'),
('888元中奖图', 'prize_888', '888.png', '/image/coupon/888.png', '中奖弹窗', '888元中奖图'),
('188优惠券', 'coupon_188', '满500且消费一道特色菜可使用.png', '/image/coupon/满500且消费一道特色菜可使用.png', '券包页面', '188优惠券展示'),
('588优惠券', 'coupon_588', '满1500且消费一道特色菜可使用.png', '/image/coupon/满1500且消费一道特色菜可使用.png', '券包页面', '588优惠券展示'),
('888优惠券', 'coupon_888', '满2500且消费一道特色菜可使用.png', '/image/coupon/满2500且消费一道特色菜可使用.png', '券包页面', '888优惠券展示'),
('参与挑战获取', 'challenge_get', 'cytzhq.png', '/image/coupon/cytzhq.png', '券包页面', '参与挑战获取提示图'),
('展示菜品', 'show_dishes', 'zscp.png', '/image/coupon/zscp.png', '主页面', '展示菜品图');
